...
public class Bilim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String [] kelimeler = {"HİDROJEN","OKSİJEN","RİBOZOM","EINSTEIN","KOHEZYON"};

        // İpuçlarının bulunacağı diziyi olusturuyoruz
        final String [] ipuclari = {"Suda Bulunur","Ciğerlerimize Dolar","RNA ve Proteinlerden\n Oluşmuştur","E=mcc","Kuvveti Vardır"};
    ...
    public void btn_geri2(View v) {
        Intent intent = new Intent(Bilim.this, kategoriler.class);
