...
public class Tarih extends AppCompatActivity {
    TextView kelime,ipucu,score,kelimebilgi,textscore;
    EditText harf;
    Button dene,button3;
    int sayac = 0;
    ImageView resim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String [] kelimeler = {"MEHMET","KURTULUS SAVASI","YENICERI","YAVUZ", "GÖKTÜRK","TALAS"};

        // İpuçlarının bulunacağı diziyi olusturuyoruz
        final String [] ipuclari = {"Cihan Fatihi","Savaş","Osmanlı'da Asker","İlk Osmanlı Halifesi","Yazıtlar","Türkler'e Müslümanlığı Getirdi"};
    ...
    public void btn_geri2(View v) {
        Intent intent = new Intent(Tarih.this, kategoriler.class);
