...
public class Eglence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String [] kelimeler = {"BEYAZSHOW","FUTBOL","OYUN","PARK"};

        // İpuçlarının bulunacağı diziyi olusturuyoruz
        final String [] ipuclari = {"Bir Tür Program","Topla Oynanır","Eğlenmek İçin Yapılır","Eğlenceli Vakit Geçirilir"};
    ...
    public void btn_geri2(View v) {
        Intent intent = new Intent(Eglence.this, kategoriler.class);
